...
### 分析
A:信噪比 $S/N$ 常用分贝 (dB) 表示,数值上等于 ${10}{\log }_{10}\left( {S/N}\right) \mathrm{{dB}}$ 。依题意有 ${30} = {10}{\log }_{10}\left( {S/N}\right)$ , 解出 $S/N = {1000}$ 。根据香农定理,最大数据传输速率 $= {3000}{\log }_{2}\left( {1 + S/N}\right)  \approx  {30}\mathrm{{kb}}/\mathrm{s}$ 。
![](https://img.hwenyi.live/202407200138815.webp)
### 解
选C
<!--ID: 1721412115772-->
