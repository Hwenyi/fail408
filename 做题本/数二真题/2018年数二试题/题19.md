...
> 
> $S(x, y, z) = \pi \cdot \left( \frac{x}{2\pi} \right)^2 + \left( \frac{y}{4} \right)^2 + \frac{1}{2} \cdot \left( \frac{z}{3} \right)^2 \cdot \sin \frac{\pi}{3} = \frac{x^2}{4\pi} + \frac{y^2}{16} + \frac{\sqrt{3}}{36}z^2$.
> 
