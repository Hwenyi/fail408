...
### 解
![](https://img.hwenyi.live/202401182359500.webp)
【方法1】2= $\lim_{x\to0}\frac{\left[x-\frac{x^2}2+a(x^2)\right]-(ax+bx^2)}{x^2}$（泰勒公式）
则 $1-a=0\:,\:-\:\left(\frac12+b\right)=2\:,\:$ 即 $a=1\:,\:b=-\:\frac52.$
故应选（A）
