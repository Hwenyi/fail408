...
![](https://img.hwenyi.live/202407291607724.webp)
...
Q: 编译的作用是什么？
A: 将源代码翻译成目标模块。
![](https://img.hwenyi.live/202407291607725.webp)
...
![](https://img.hwenyi.live/202407291607726.webp)
其中并没有提前链接成一整个大的装入模块，而是在**装入内存时链接**
完整的逻辑地址是一边装入内存一边形成的

Q: 装入时动态链接是什么？
A: 在程序装入内存时进行链接。
![](https://img.hwenyi.live/202407291607727.webp)

Q:运行时动态链接是什么？
A:在程序执行中只有需要到该目标模块时，才进行链接。
![](https://img.hwenyi.live/202407291607728.webp)
...
![](https://img.hwenyi.live/202407291607729.webp)
**评价**：绝对装入只适合单道程序环境。
...
Q: 静态重定位的特点是什么？
A: 在装入时将逻辑地址转换为物理地址。
![](https://img.hwenyi.live/202407291607730.webp)

Q: 动态重定位(又称为动态运行时装入)的特点是什么？
A: 又称为动态运行时装入，在程序执行时才将逻辑地址转换为物理地址。
![](https://img.hwenyi.live/202407291607731.webp)
...
![](https://img.hwenyi.live/202407291607744.webp)
...
Q: 覆盖技术是为了解决什么问题？
A: 解决程序大小超过物理内存总和的问题。
![](https://img.hwenyi.live/202407291607740.webp)
...
Q: 交换技术对应哪种进程调度？
A: 中级调度（内存调度）。
![](https://img.hwenyi.live/202407291607741.webp)
...
![](https://img.hwenyi.live/202407291607745.webp)
...
![](https://img.hwenyi.live/202407291547041.webp)
...
![0190de02-3c6a-77ee-9509-aa0f897ee3dc_192_204030.jpg](https://img.hwenyi.live/202407291547042.webp)
...
![](https://img.hwenyi.live/202407291607746.webp)
![](https://img.hwenyi.live/202407291607747.webp)
...
![](https://img.hwenyi.live/202407291607748.webp)
...
![](https://img.hwenyi.live/202407291607749.webp)
![](https://img.hwenyi.live/202407291607748.webp)
...
![](https://img.hwenyi.live/202407291607767.webp)
![](https://img.hwenyi.live/202407291607750.webp)
...
A: 空闲分区表和空闲分区链。
![](https://img.hwenyi.live/202407291607752.webp)
![](https://img.hwenyi.live/202407291607751.webp)
...
实现：**空闲分区以地址递增的次序排列**。
![](https://img.hwenyi.live/202407291607752.webp)
![](https://img.hwenyi.live/202407291607754.webp)
...
实现：空闲分区**按容量递增次序链接**。
缺点：会产生很多外部碎片。
![](https://img.hwenyi.live/202407291607757.webp)

Q: 简述最快适应算法的思想和实现方式，并说明其缺点。
A: 思想：优先使用最大的空闲分区。
实现：空闲分区**按容量递减次序链接**。
缺点：大空闲区容易被耗尽，不利于大进程。
![](https://img.hwenyi.live/202407291607762.webp)
![](https://img.hwenyi.live/202407291607763.webp)
...
优点：减少查找开销，可能保留大空闲区。
缺点：可能导致外部碎片。
![](https://img.hwenyi.live/202407291607765.webp)
![](https://img.hwenyi.live/202407291607766.webp)
...
![](https://img.hwenyi.live/202407291607782.webp)

Q: 动态分区分配的缺点是什么？
A: 存在**外部**碎片，可能需要紧凑技术来解决。
外部碎片：指的是内存中某些空闲分区由于太小而难以利用。
![](https://img.hwenyi.live/202407291607779.webp)
![](https://img.hwenyi.live/202407291607782.webp)
...
![](https://img.hwenyi.live/202407291607781.webp)
...
![](https://img.hwenyi.live/202407291607787.webp)
...
Q: 逻辑地址如何构成?
A: 逻辑地址由页号和页内偏移量组成。
![](https://img.hwenyi.live/202407291607790.webp)
![](https://img.hwenyi.live/202407291607785.webp)
**回顾知识**：若是进程在**内存中连续存放**的时候，通过借助指令中的偏移量以及重定位寄存器中的值相加即可得到一个物理地址：
![](https://img.hwenyi.live/202407291607789.webp)
...
![](https://img.hwenyi.live/202407291607793.webp)
**对于页面大小刚好为 2 的整数幂更加详细的可以看下王道的说明**：
![](https://img.hwenyi.live/202407291607794.webp)
...
![](https://img.hwenyi.live/202407291607798.webp)
...
![](https://img.hwenyi.live/202407291607799.webp)
![](https://img.hwenyi.live/202407291607800.webp)
...
![](https://img.hwenyi.live/202407291607801.webp)

## 页表项大小探讨

Q: 为什么**页表项**大小通常设置为 2 的幂？
A: 为了简化页表的查询，通常将页表项大小设置为 2 的幂，确保每个页面可以恰好装下整数个页表项，避免空间浪费，方便地址计算。
![](https://img.hwenyi.live/202407291607804.webp)
...
![](https://img.hwenyi.live/202407291607808.webp)
...
![](https://img.hwenyi.live/202407291607822.webp)
...
![](https://img.hwenyi.live/202407291607816.webp)
...
![](https://img.hwenyi.live/202407291607824.webp)
...
![](https://img.hwenyi.live/202407291607825.webp)
...
![](https://img.hwenyi.live/202407291607826.webp)
...
![](https://img.hwenyi.live/202407291607829.webp)
...
![](https://img.hwenyi.live/202407291607830.webp)
...
![](https://img.hwenyi.live/202407291607832.webp)
...
![](https://img.hwenyi.live/202407291607835.webp)
...
![](https://img.hwenyi.live/202407291607846.webp)
...
![](https://img.hwenyi.live/202407291607847.webp)
...
![](https://img.hwenyi.live/202407291607848.webp)
