...
![](https://img.hwenyi.tech/202407091916558.webp)
...
2. 封装成帧：在帧头帧尾加上帧的定界符。
3. 透明传输：与帧定界符一样比特组合的数据应该如何处理；异步线路用字节填充，同步线路用比特填充。![](https://img.hwenyi.tech/202407182016513.webp)
...
Q: PPP 帧格式的组成是什么？
A: ![](https://img.hwenyi.tech/202407182002781.webp)
- 帧定界符：首尾都有标志字段。
...
Q: PPP 协议的状态图有哪些状态？  
A: ![](https://img.hwenyi.tech/202407182036267.webp)
- 链路静止状态
- 链路建立状态
- 鉴别状态
- 网络层协议状态
