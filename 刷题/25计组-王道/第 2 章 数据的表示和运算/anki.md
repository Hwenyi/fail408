...
![](https://img.hwenyi.tech/202407241411653.webp)

Q: 定点小数的机器码表示范围是什么？
A: ![](https://img.hwenyi.tech/202407241411653.webp)
- 零的原码表示有两种。
- 最小正数的值为 $2^{-N}$。
- 最大正数的值为 $1 - 2^{-N}$。
...
![](https://img.hwenyi.tech/202407241438386.webp)
只有最后这个表达形式符合，因为后面卡其色覆盖的部分得是一定点小数
![](https://img.hwenyi.tech/202407241440713.webp)

Q: 浮点数（单精度和双精度）的阶码和尾数分别由多少个二进制位构成？
A: ![](https://img.hwenyi.tech/202407241448880.webp)
...
Q: 浮点数的表示范围如何确定？
A: ![](https://img.hwenyi.tech/202407241445975.webp)
- 最大正数：阶码最大值，尾数最大值。
- 最小正数：阶码最小值，尾数最小值。
- 最大负数：阶码最大值，尾数最小值。
- 最小负数：阶码最小值，尾数最大值。
![](https://img.hwenyi.tech/202407241446268.webp)

#### 浮点数的溢出

Q: 什么是浮点数的上溢和下溢？
A: ![](https://img.hwenyi.tech/202407241447316.webp)
...
![](https://img.hwenyi.tech/202407241506106.webp)

#### 规格化方法

Q: 浮点数（二进制）的规格化方法有哪些？
A: 左归：尾数数值部分每左移一位，阶码减一。
![](https://img.hwenyi.tech/202407241507430.webp)
右归：尾数数值部分每右移一位，阶码加一。
![](https://img.hwenyi.tech/202407241510760.webp)

Q:基数r和浮点数的精度的关系是怎么样的？
A:基数r越大，可表示的**浮点数范围越大**，而且所表示的数的个数越多，但浮点数的**精度反而下降**
![](https://img.hwenyi.tech/202407241513165.webp)

#### 规格化对浮点数的影响

Q: 规格化对浮点数的表示范围和精度有什么影响？
A: ![](https://img.hwenyi.tech/202407241514162.webp)
- 规格化后，浮点数的表示范围不变，但可以提高精度。
- 尾数的最高位为一，避免了无效的零。

Q:设浮点数字长为16位,其中阶码5位(含1位阶符),尾数11位(含1位数符),将十进制数-56写成二进制定点数和浮点数(要求规格化表示),并分别写出它们各自的机器数(原码、反码、补码)形式。 
![](https://img.hwenyi.tech/202407241530788.webp)
A:![](https://img.hwenyi.tech/202407241530661.webp)
...
![](https://img.hwenyi.tech/202407241547890.webp)

#### IEEE754 单精度浮点数阶码

Q: IEEE754 单精度浮点数的阶码如何表示？
A: IEEE754 单精度浮点数的阶码占 8 位，采用阶码表示，偏移常数为 127。
![](https://img.hwenyi.tech/202407241556913.webp)

Q: 为什么 IEEE754 单精度浮点数的阶码采用偏移常数 127 而不是 128？
A: ![](https://img.hwenyi.tech/202407241555475.webp)
...
![](https://img.hwenyi.tech/202407241600595.webp)
![](https://img.hwenyi.tech/202407241603468.webp)
...
![](https://img.hwenyi.tech/202407252009187.webp)
...
A: ![](https://img.hwenyi.tech/202407281844248.webp)
1. 将十进制数转换为二进制形式。
2. 将二进制数转换为规格化形式。
...
A: ![](https://img.hwenyi.tech/202407281844877.webp)
...
Q: char 型变量的取值范围是什么？
A: ![](https://img.hwenyi.tech/202407262004082.webp)
- `unsigned char`: 0 ~ 255
- `char`: -128 ~ 127

Q: short 型变量的取值范围是什么？
A: ![](https://img.hwenyi.tech/202407262004712.webp)
...
![](https://img.hwenyi.tech/202407262046605.webp)

#### 相同字长之间的转换

Q: 相同字长之间的转换如何进行？
A: 相同字长之间的转换只需要保持机器码不变即可。
![](https://img.hwenyi.tech/202407262006609.webp)
![](https://img.hwenyi.tech/202407262007707.webp)
![](https://img.hwenyi.tech/202407262010059.webp)
![](https://img.hwenyi.tech/202407262011492.webp)

#### 大字长转小字长

Q: 大字长转小字长时会发生什么？
A: 编译器会将机器码截短处理，可能会导致数据丢失。（向前截断）
![](https://img.hwenyi.tech/202407262026272.webp)
...
A: 转换后的数据与原值相同。
- 能保留精确值。
![](https://img.hwenyi.tech/202407262107144.webp)

Q: float 转 double 时会发生什么？
A: 转换后的数据与原值相同。
- 能保留精确值。
![](https://img.hwenyi.tech/202407262053880.webp)
...
- 判断方法
    ...
    - 写为±1x...x×2^n形式
    - 小数点后位数超过23位则损失
![](https://img.hwenyi.tech/202407281850957.webp)

#### 总结

Q: C语言中数据类型转换需要注意哪些问题？
A: ![](https://img.hwenyi.tech/202407262107693.webp)
...
![](https://img.hwenyi.tech/202407281858208.webp)
...
Q: 逻辑移位运算的规则是什么？
A: ![](https://img.hwenyi.tech/202407262113131.webp)
- 逻辑左移：高位移除，低位补零。
- 逻辑右移：低位移除，高位补零。
...
A: ![](https://img.hwenyi.tech/202407262115076.webp)
...
A: ![](https://img.hwenyi.tech/202407262116825.webp)
1. 定义一个掩码，该掩码的第六位为 1，其他位为 0。
2. 将掩码与寄存器内容进行或运算。
3. 将或运算的结果写回寄存器。
...
![](https://img.hwenyi.tech/202407262120425.webp)

Q: 算术移位运算的规则是什么？
A: ![](https://img.hwenyi.tech/202407262120425.webp)
- 符号位保持不变。
- 仅对数值位进行移位。
...
- 若最高位丢 1，则结果出错。
![](https://img.hwenyi.tech/202407262127074.webp)
...
- 若最低位丢 1，则结果的**精度缺失**。
![](https://img.hwenyi.tech/202407262128696.webp)
注意这里的这个末尾的小数点
![](https://img.hwenyi.tech/202407262131049.webp)

Q: 反码的算术移位规则
A: 和原码的情况相反即可
![](https://img.hwenyi.tech/202407262146409.webp)

Q:补码的算数移位规则 
A:左移补充0，右移补充1
![](https://img.hwenyi.tech/202407262146409.webp)
![](https://img.hwenyi.tech/202407262147634.webp)

#### 补码的另一种算术移位方法

Q: 补码的另一种算术移位方法，也就是"**符号位也参与移位**"，是什么？
A: ![](https://img.hwenyi.tech/202407270858854.webp)
- 符号位也参与移位。
- 左移：高位移除，低位补零，若符号发生变化，则发生溢出。
- 右移：低位移除，高位填补符号位。
![](https://img.hwenyi.tech/202407270858829.webp)
...
Q: C 语言中的移位运算符有哪些？
A: ![](https://img.hwenyi.tech/202407270900930.webp)
- `<<`: 左移运算符。
- `>>`: 右移运算符。
...
![](https://img.hwenyi.tech/202407270911158.webp)
...
![](https://img.hwenyi.tech/202407270917452.webp)
...
![](https://img.hwenyi.tech/202407270921990.webp)
...
A: ![](https://img.hwenyi.tech/202407270926425.webp)
...
A:![](https://img.hwenyi.tech/202407270938251.webp)
...
A: ![](https://img.hwenyi.tech/202407270947295.webp)
- 变形补码具有两个符号位。
- 双符号位为 00 时表示正数。
- 双符号位为 11 时表示负数。
- 双符号位为 01 时表示正溢出。
...
Q: 与运算的规则是什么？
A: 只有输入都为真时，输出才为真。
![](https://img.hwenyi.tech/202407270956380.webp)
...
![](https://img.hwenyi.tech/202407271206820.webp)
...
- 符号标志位 (SF)
- 进位标志位 (CF)
![](https://img.hwenyi.tech/202407271220324.webp)
