...
Q: 如何在磁盘中读/写数据？
A: ![](https://img.hwenyi.tech/202408061429982.gif)
1. 将磁头移动到要读/写的扇区所在的磁道。
2. 磁盘旋转，使目标扇区从磁头下面划过。
3. 磁头读取或写入扇区中的数据。
![](https://img.hwenyi.tech/202408061429983.webp)
...
A: ![](https://img.hwenyi.tech/202408061429985.webp)
- 活动头磁盘：磁头可移动。
- 固定头磁盘：磁头不可移动。
![](https://img.hwenyi.tech/202408061429986.webp)

Q: 根据盘片是否可更换，磁盘可以分为哪两类？
A: ![](https://img.hwenyi.tech/202408061429987.webp)
- 可换盘磁盘：盘片可更换。
- 固定盘磁盘：盘片不可更换。
...
![](https://img.hwenyi.tech/202408061429990.gif)
...
旋转延迟时间 = (1/2) * (1/r) = 1/2r，其中 r 是磁盘转速。
    ![](https://img.hwenyi.tech/202408061429991.gif)
...
![](https://img.hwenyi.tech/202408061429992.gif)
...
![](https://img.hwenyi.tech/202408061429993.webp)
...
![](https://img.hwenyi.tech/202408061429994.webp)
...
初始访问的磁道如下图为：
![](https://img.hwenyi.tech/202408061429995.webp)
流程：从 100 开始出发，首先找离最近的磁道就是 90，接着还是找最近的，之后依旧是这个策略 58、55、39、38、18，后面才是 150、160、184。
![](https://img.hwenyi.tech/202408061429996.webp)
...
![](https://img.hwenyi.tech/202408061429997.webp)
...
![](https://img.hwenyi.tech/202408061429998.webp)
...
![](https://img.hwenyi.tech/202408061429001.webp)
...
![](https://img.hwenyi.tech/202408061429002.webp)
...
描述：假设磁盘的磁道为 0-200 号，磁头初始位置为 100 号磁道，且此时磁头正在往磁道号增大的方向移动，有多个进程先后陆续地请求访问 55、58、39、18、90、160、150、38、184 号磁道。
![](https://img.hwenyi.tech/202408061429003.webp)
...
![](https://img.hwenyi.tech/202408061429004.webp)
...
![](https://img.hwenyi.tech/202408061429008.gif)

### 3.3.2 交替编号

Q: 交替编号如何减少延迟时间？
A: 交替编号使得磁头在读取一个扇区后，下一个逻辑扇区已经旋转到磁头下方，从而减少了磁头等待磁盘旋转的时间。
![](https://img.hwenyi.tech/202408061429009.gif)

### 3.3.3 磁盘地址结构的设计

Q: 为什么磁盘地址结构采用（柱面号，盘面号，扇区号）而不是（盘面号，柱面号，扇区号）？
A: 因为采用（柱面号，盘面号，扇区号）的地址结构，在读取地址连续的磁盘块时，可以减少磁头移动消耗的时间。
![](https://img.hwenyi.tech/202408061429010.webp)
![](https://img.hwenyi.tech/202408061429012.gif)

Q: 解释为什么（柱面号，盘面号，扇区号）的地址结构可以减少磁头移动时间？
A: ![](https://img.hwenyi.tech/202408061429013.webp)
...
![](https://img.hwenyi.tech/202408061429014.gif)
![](https://img.hwenyi.tech/202408061429016.webp)
...
![](https://img.hwenyi.tech/202408061429021.webp)
...
1. 低级格式化（物理格式化）：将磁盘的各个磁道划分为扇区，并在扇区的头部和尾部写入管理扇区所需的数据结构，例如扇区校验码。
    1. ![](https://img.hwenyi.tech/202408061429021.webp)
2. 分区：将磁盘划分为多个分区，例如 C 盘、D 盘、E 盘。
    1. ![](https://img.hwenyi.tech/202408061429022.webp)
...
![](https://img.hwenyi.tech/202408061429025.webp)
