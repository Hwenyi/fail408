...
![](https://img.hwenyi.live/202401222138255.webp)
...
线代入门这里有点抽象，直接用自己的记法
![](https://img.hwenyi.live/202401222150056.webp)
左侧取行和右侧的列向量做乘积运算，得到就是左侧行数为 i，后侧列数为 j 的元素的值，也就是，左侧第一行，右侧第二列，得到 $\displaystyle c_{12}$ c 的第一行第二列

![](https://img.hwenyi.live/202401222152378.webp)
矩阵与列向量乘积和矩阵乘积有结合率
更一般的，乘法满足结合律
![](https://img.hwenyi.live/202401222218332.webp)
但是乘法的交换律和消去率不成立
