...
**任何**二次型总可以用配方法化成[[标准形]]、[[规范形]], 且所作变换均是**可逆线性变换**，用矩阵的语言表述;;; **任何**[[实对称矩阵]] $\mathbf{A}$，必存在**可[[逆矩阵]] $\mathbf{C}$** ，使得 ${\mathbf{C}}^{T}\mathbf{A}\mathbf{C} = \mathbf{A}$ ，其中 $\mathbf{A}$ 是[[对角矩阵]]，或是对角元素取值范围为 $\{1, {-} 1,0\}$ 的对角矩阵.
<!--ID: 1725636630811-->

[21:10](https://www.bilibili.com/video/BV1Ti421D727?p=49&t=1270.758395#t=21:10.76) 
![](https://img.hwenyi.live/202406111812058.webp)
...
A:任何二次型$f(x)=x^{T}Ax$可以通过[[正交变换]]$x=Qy$化为[[算标准形]]，这个过程就是[[正交对角化]]，用矩阵语言描述就是：任何[[实对称矩阵]]$A$，一定存在[[正交矩阵]]Q（不唯一），使得
$$Q^{-1}AQ=Q^{\mathrm{T}}AQ=\Lambda$$
$$A=\begin{bmatrix}\lambda_1&&&\\&\lambda_2&&\\&&\ddots&\\&&&\lambda_n\end{bmatrix}$$
![](https://img.hwenyi.live/202406111847798.webp)
<!--ID: 1725636630806-->
...
![](https://img.hwenyi.live/202406112019137.webp)
...
![](https://img.hwenyi.live/202406112129145.webp)

[53:32](https://www.bilibili.com/video/BV1Ti421D727?p=50&t=3212.340439#t=53:32.34) 
正交变换可以形成局面
![](https://img.hwenyi.live/202406112206000.webp)

![](https://img.hwenyi.live/202406112212773.webp)
